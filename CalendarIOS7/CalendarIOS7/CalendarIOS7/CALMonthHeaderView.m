...
- (void)setup
{
    ...
    UILabel *masterLabel = [[UILabel alloc] initWithFrame:CGRectMake(0.0f, 5.0f, CGRectGetWidth(self.frame), 20.f)];
    [masterLabel setBackgroundColor:[UIColor clearColor]];
    [masterLabel setTextAlignment:NSTextAlignmentCenter];
    [masterLabel setFont:[UIFont fontWithName:@"Avenir-Medium" size:15]];
    ...
    [dayOfTheWeekLabel setFont:[UIFont fontWithName:@"Avenir-Medium" size:12.0f]];
